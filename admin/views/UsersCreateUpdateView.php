    ...
    <div class="panel panel-primary">
        ...
        <form method="post" action="<?php echo $action; ?>">
            ...
            <div class="row" style="margin-top:5px;">
                ...
                <div class="col-md-10">
                    <input type="email" value="<?php echo isset($record->email)?$record->email:""; ?>" <?php if(isset($record->email)): ?> placeholder="Nhập password mới nếu update password" disabled <?php else: ?> required <?php endif; ?> name="email" class="form-control">
                </div>
            </div>
            <!-- end rows -->
            <!-- rows -->
